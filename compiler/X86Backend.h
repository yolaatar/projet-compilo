...
public:
    ...
    virtual void gen_jump_cond(std::ostream &os, const std::string &cond, const std::string &labelTrue, const std::string &labelFalse) const override;
    virtual void gen_jump(std::ostream &os, const std::string &label) const override;
